...
"Diastolic":"Diastolic"
	...
	if(str == "FRENCH"){
		...
		"Search by Vaccination Name": "Rechercher par Vaccination",
		...
		"Visits-Conditions":"Visites-Maladies",
		  "Zip": "Code Postal",
		   "Delete Visit":"Effacer Visite",
"Edit Alert":"Editer Alerte",
"Edit Visit":"Editer Visite",
"Edit Medication":"Editer Medicament",
"Edit Vaccination":"Editer Vaccination",
"Delete Vaccination":"Effacer Vaccination",
"Edit Allergy":"Editer Allergie",
"Delete Allergy":"Effacer Allergie",
"Medication Name":"Nom de Medicament",
"Medications":"Medicaments",
"Delete Medication":"Effacer Medicament",
"Delete Condition":"Effacer Maladie",
"Add New Condition": "Ajouter Nouvelle Maladie",
"Add New Doctor": "Ajouter Nouveau Docteur",
"Add New Medication": "Ajouter Nouveau Medicament",
"Add New Visit Type": "Ajouter Nouveau Type de Visite",
"Delete Visit":"Effacer Visite",
"Edit Note":"Editer Remarque",
"Delete Note":"Effacer Remarque",
"Edit Patient Information":"Editer les Informations du Patients",
"Cancel": "Quitter",
"Visit Types":"Types de Visite",
"Visit Type":"Type de Visite",
"Add New Patient Allergy":"Ajouter Nouvelle Allergie au Patient",
"Add New Patient Vaccination":"Ajouter Nouvelle Vaccination au Patient",
"Delete Visit Type":"Effacer Type de Visite",
'Please enter a new prescription for "New"': 'SVP Entrer une Nouvelle Ordonnance a "Nouveau"',
'Please enter a new condition for "Other"': 'SVP Entrer une Nouvelle Maladie a "Autre"',
'Please enter a new allergy for "Other"':'SVP Entrer une Nouvelle Allergie a "Autre"',
'Please enter a new visit type for "New"':'SVP Entrer une Nouvelle Visite a "Nouveau"',
'Please enter a new vaccination for "Other"':'SVP Entrer une Nouvelle Vaccination a "Nouveau"',
"You do not have permission to view this page.":"Vous n'avez pas la permission pour voir cette page",
"Error":"Erreur",
"Physical Data":"Donnees Physiques",
"Data Graphs":"Graphe des Donnees",
"Log":"Journal",
"Could not contact server.":"Ne peut pas contacter le serveur",
"Accounts List":"Liste des Comptes",
"Accounts":"Comptes",
"Delete User":"Effacer Utilisateur",
"Doctors":"Docteurs",
"Doctors List":"Liste des Docteurs",
"Delete Doctor":"Effacer Docteur",
"Cannot delete admin account.":"Ne peut pas effacer un compte administrateur",
"Data Graphs":"Graphe des Donnees",
"Height":"Taille",
"Weight":"Poids",
"Systolic Blood Pressure":"Tension Artérielle Systolique",
"Diastolic Blood Pressure":"Tension Artérielle Diastolique",
"Blood Pressure":"Tension Arterielle",
"Systolic":"Systolique",
"Diastolic":"Diastolique",
"Temperature":"Temperature",
"Pulse":"Pouls",
"Delete Prescription":"Effacer Ordonance",

'Your telephone number contains invalid characters.':'Votre Numero de Telephone contient des caracteres invalides',
'Your telephone number must contain at least 10 digits.':'Votre Numero de Telephone doit Contenir au moins 10 Chiffres',
'This field is shorter than the minimum allowed length.':'Ce champs de caractere est plus petit que le minimum permis',
'The amount may not be negative.':'Cette valeur ne devrait pas etre negative',
'The decimal separator occur only once.':"La separation des decimaux doit apparaitre qu'une seule fois",
'The number must be an integer.':'Ce nombre doit etre entier',
'This field is required.':'Ce champ doit etre rempli',
'The amount entered is too small.':'La valeur entree est trop petite',
'The input contains invalid characters.':'Votre entree contient des caracteres invalides',
			"Browse" : "Browse(French)",
