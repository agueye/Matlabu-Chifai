class MedicationsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @medication.save
        ...
        APP_LOGGER_LOG.info "MEDICATION CREATED - " + @medication[:name] + 
  ...
  def update
    ...
    respond_to do |format|
      if @medication.update_attributes(params[:medication])
        ...
        APP_LOGGER_LOG.info "MEDICATION UPDATED - " + @medication[:name] + 
          " by USER " + self.current_user[:login]
  ...
  def destroy
    ...
    APP_LOGGER_LOG.info "MEDICATION DELETED - " + @medication[:name] + 
      " by USER " + self.current_user[:login]
