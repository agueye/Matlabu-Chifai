...
describe "/patient_visits/edit.html.erb" do
  ...
  it "renders the edit patient_visit form" do
    render

    response.should have_tag("form[action=#{patient_visit_path(@patient_visit)}][method=post]") do
