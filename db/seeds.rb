...
User.create(:institution => tier, :username => 'user', :email => 'userEmail@fake.fake', :password => 'pass')
User.create(:institution => tier, :username => 'admin', :email => 'adminEmail@fake.fake', :password => 'pass', :admin => 1)
