...
User.create(:institution => tier, :email => 'brianmaissy@berkeley.edu', :password_hash => 'placeholder', :username => 'Brian', :admin => 1)
User.create(:institution => tier, :email => 'brianmaissy@berkeley.edu', :password_hash => 'placeholder', :username => 'User', :admin => 0)
